  ...
  def determine_flickr_cue_image(text)
    require 'open-uri'
    require 'linguistics'
  ...
  def get_flickr_image_for_tags(tag_list)
  ...
  def get_flickr_image_for_keywords(text)
  ...
  def get_flickr_image_for_query_url(query_url)
    ce query_url
    sleep 1
